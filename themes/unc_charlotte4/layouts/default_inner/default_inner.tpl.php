...
<?php if ($main_menu || $secondary_menu): ?>
  <div id="mobile-navbar" class="visible-phone">
    ...
    <div id="mobile-buttons" class="<?php print ($search_type == 'disabled') ? "search-disabled" : "search-enabled"; ?>">
      <button id="mobile-menu-button"><i class="fa fa-bars" aria-hidden="true"></i> Menu</button>
      <button id="mobile-search-button"><i class="fa fa-search" aria-hidden="true"></i> Search</button>
    </div>
