...
/**
 * @file
 * Theme settings file for the unc_charlotte4 theme.
 */
 ...
 */
function unc_charlotte4_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['unc_charlotte4_theme_options'] = array(
    '#type' => 'fieldset',
    '#title' => t('unc_charlotte4 Theme Options'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
    '#weight' => -11,
  );
  $form['unc_charlotte4_theme_options']['subbrand_text'] = array(
    '#type' => 'textfield',
  ...
  $form['unc_charlotte4_theme_options']['subbrand_link'] = array(
    '#type' => 'textfield',
  ...
  $form['unc_charlotte4_theme_options']['utility_link_3_text'] = array(
    '#type' => 'textfield',
  ...
  $form['unc_charlotte4_theme_options']['utility_link_3_link'] = array(
    '#type' => 'textfield',
  ...
  $form['unc_charlotte4_theme_options']['utility_link_4_text'] = array(
    '#type' => 'textfield',
  ...
  $form['unc_charlotte4_theme_options']['utility_link_4_link'] = array(
    '#type' => 'textfield',
  ...
  $form['unc_charlotte4_theme_options']['search_box_type'] = array(
    '#type' => 'radios',
  ...
  $form['unc_charlotte4_theme_options']['nav_style'] = array(
    '#type' => 'select',
  ...
  $form['unc_charlotte4_theme_options']['mobile_menu'] = array(
    '#type' => 'select',
    '#title' => t('Mobile Menu'),
