 ...
 */
function starterkit_menu_tree__menu_social_menu($variables){
  return '<ul class="menu">' . $variables['tree'] . '</ul>';
}
function starterkit_menu_link__menu_social_menu($variables){
...
function starterkit_links__system_main_menu($variables) {
...
function starterkit_links__system_mobile_menu($variables) {
 ...
 */
function starterkit_header_utility() {
...
function starterkit_preprocess_user_login(&$vars) {
 ...
 */
function starterkit_date_all_day_label() {
