 ...
 *along the right side of the template. In order to enable that
 *functionality, this must be un-commented as well as the longscroll.js
 *file in longscroll.layout.inc
      <div id="nav">
      <ul>
...
*/
    ...
    <div id="content" class="l-main">
      <?php /*note the $page['content'] section does not appear here. This longscroll
      layout was designed to contain panels or blocks of content edited separate
      from the node they reside on.*/?>
      <ul>
        <li id="a1">
            ...
            <div id="utility-bar" class="span12">
              <div class="row">
                <div id="footer-links" class="span9">
                  <ul>
                    <li><img style="margin-top: 7px;" alt="Small UNC Charlotte Crown Logo" src="/sites/all/themes/starterkit/img/crown-small.png"></li>
                    ...
                    <li><img height="20" width="20" style="display: inline-block; margin: 7px 6px 0 0; vertical-align: middle;" title="" alt="accessibility icon" src="/sites/all/themes/starterkit/img/accessibility-icon.png"><a style="vertical-align: top;" title="Accessibility resources at UNC Charlotte" href="http://www.uncc.edu/accessibility">Accessibility</a></li>
                  </ul>
                </div> <!--/#footer-links-->
                <div id="footer-search" class="span3">
                  <form action="http://search.uncc.edu/website/" method="get" id="utility-search" onsubmit="var searchbox = document.getElementById('utility-search-input'); if (searchbox.value == 'Search uncc.edu' || searchbox.value == '') { searchbox.value=''; searchbox.focus(); return false; }"><input type="image" src="/sites/all/themes/starterkit/img/utility-edu-search-mag.png" id="utility-search-button"><input type="text" name="q" value="Search uncc.edu" size="25" maxlength="100" title="" onclick="if (this.value == 'Search uncc.edu') { this.value = ''; }" id="utility-search-input"></form>
                </div> <!--/#footer-search-->
              </div> <!--/.row-->
            </div> <!--#utility-bar -->
          </div> <!--/.row-->
            ...
            <div id="footer-bottom" class="span12">
              <div class="row">
                ...
                <div id="footer-follow" class="span3 offset3">
                  ...
                  <div class="facebook social-icons"><a target="_blank" title="Facebook" href="http://www.facebook.com/UNCCharlotte"><img height="20" width="20" alt="Facebook" src="/sites/all/themes/starterkit/img/1x1.gif"></a></div>
                  <div class="blog social-icons"><a target="_blank" title="Blogger" href="http://unccltnews.blogspot.com/"><img height="20" width="20" alt="Blogger" src="/sites/all/themes/starterkit/img/1x1.gif"></a></div>
                  <div class="twitter social-icons"><a target="_blank" title="Twitter" href="http://twitter.com/UNCCharlotte"><img height="20" width="20" alt="Twitter" src="/sites/all/themes/starterkit/img/1x1.gif"></a></div>
                  <div class="flickr social-icons"><a target="_blank" title="Flickr" href="http://www.flickr.com/photos/stakeyourclaim/sets"><img height="20" width="20" alt="Flickr" src="/sites/all/themes/starterkit/img/1x1.gif"></a></div>
                  <div class="youtube social-icons"><a target="_blank" title="YouTube" href="http://www.youtube.com/unccharlottevideo"><img height="20" width="20" alt="YouTube" src="/sites/all/themes/starterkit/img/1x1.gif"></a></div>
                </div> <!-- #footer-follow -->
              </div> <!--/.row-->
            </div> <!-- #footer-bottom -->
          </div> <!--/.row-->
